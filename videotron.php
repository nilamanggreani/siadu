...
<body id="page-top">
    ...
    <div id="content">
                <div style="text-align: center">
                    <h2 class="h3 mb-2 text-gray-800">PERMOHONAN VIDEOTRON</h2>
      ...
      <div class="row">
        ...
        <div class="col-75">
        <input type="file" id="dokumen_iklan" name="dokumen_iklan" accept="video/mp4" required>
        </div>
      </div>
      <div class="row">
        <div class="col-25">
        ...
        <div class="col-75">
          <textarea id="deskripsi_iklan" name="deskripsi_iklan" placeholder="Deskripsi Video" style="height:120px" required></textarea>
        </div>
      </div>
