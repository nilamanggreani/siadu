...
<head>
    ...
    <link rel="stylesheet" href="css/user/ajuan-videotron-saya.css">
    ...
    <div class="container">
        <div id="content">
            <div style="text-align: center">
                <h2 class="h3 mb-2 text-gray-800">AJUAN VIDEOTRON SAYA</h2>
                    ...
                    <?php while ($data = mysqli_fetch_array($hasil)) { $no++; ?>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php if ($data["status_permohonan"] == "ditolak") { ?>
                                            ...
                                            <p>Catatan: 
                                                <br> 
                                                Video yang diajukan belum memenuhi kriteria iklan layanan masyarakat.</p>
                                        <?php } else { 
                                            $status_permohonan = str_replace('diterima', 'Diterima', $data["status_permohonan"]);
                                        ?>
                                            <p>Status Permohonan: 
                                                <br>
                                                <?php echo $status_permohonan; ?></p>
                                        <?php } ?>
                                    </div>
                        ...
                        <div class="modal fade" id="modalDetail_<?php echo $data['id_ajuan']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalDetailLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalDetailLabel">Detail Status Ajuan Videotron</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
