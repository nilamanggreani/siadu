...
<body>
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo '<img src="data:image/jpeg;base64,' . base64_encode($data['dokumen_iklan']) . '" />';
        echo '</div>';
        echo '</div>';
    } else {
        echo '<div class="container">';
